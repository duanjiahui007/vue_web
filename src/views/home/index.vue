<template>
  <div class="homePage">
    <!-- 广告图 -->
    <div class="banner">
      <img :src="grass" class="grass" alt="grass" />
      <div class="figure">
        <img :src="cloud" alt="cloud" class="cloud" />
        <img :src="book" alt="book" class="book" />
      </div>
      <div class="content">
        ...
        <div class="banner-conent">
          All that's missing from your successful life is a perfect resume
        </div>
